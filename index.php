		...
		<nav class="navbar navbar-expand-md navbar-dark mb-4 offset-3">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="#skill">Compétence</a>
					</li>
					<li class="nav-item">
	...
	<section class="container">
		<div class="row">
			<div class="col-md-12" id="skill">
				...
				<br>
				<div class="progress" style="height: 20px">
					<div class="progress-bar progress-bar-striped" style="width:45%">
						Java script / jquery
					</div>
				</div>
				<br>
				<div class="progress" style="height: 20px">
					<div class="progress-bar progress-bar-striped bg-danger" style="width:40%">
						laravel / symfony
					</div>
				</div>
				<br>
				<div class="progress" style="height: 20px">
					<div class="progress-bar progress-bar-striped bg-info" style="width:30%">
						css
					</div>
				</div>
				<br>
				<div class="progress" style="height: 20px">
					<div class="progress-bar progress-bar-striped bg-secondary" style="width:15%">
						Phaser
					</div>
				</div>
			</div>
